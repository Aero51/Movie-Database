...
import com.aero51.moviedatabase.repository.MovieVideosRepository
...
class DetailsViewModel(application: Application) : AndroidViewModel(application) {
    ...
    init {
        ...
        movieVideosRepository= MovieVideosRepository(application,executors)
    }
    ...
    fun getVideosForMovie(movie_id: Int): LiveData<Resource<List<MovieVideosResponse.MovieVideo>>> {
        return movieVideosRepository.loadVideosForMovie(movie_id)
    }
