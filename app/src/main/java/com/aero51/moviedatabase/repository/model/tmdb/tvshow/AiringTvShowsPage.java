...
@Entity(tableName = "airing_tv_shows_page")
public class AiringTvShowsPage {
    ...
    @Ignore
    private List<AiringTvShow> results;

    @Ignore
    public AiringTvShowsPage(Integer page, Integer total_results, Integer total_pages, List<AiringTvShow> results) {
        this.page = page;
    ...
    public AiringTvShowsPage(Integer page, Integer total_results, Integer total_pages) {
        this.page = page;
        this.total_results = total_results;
        this.total_pages = total_pages;
    }
    ...
    public List<AiringTvShow> getResults() {
        return results;
    }

    @Entity(tableName = "airing_tv_show")
    public static class AiringTvShow {
