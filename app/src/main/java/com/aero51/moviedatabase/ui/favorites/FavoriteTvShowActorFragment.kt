...
class FavoriteTvShowActorFragment : Fragment(),
    MediaClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        sharedViewModel!!.liveDataFavoriteTvShowActorId.observe(viewLifecycleOwner, { actorId -> registerActorObservers(actorId) })
    ...
    override fun onMediaItemClick(tv_show: Any?, position: Int) {
        sharedViewModel?.changeToFavoriteTvShowDetailsFragmentFromTvShowActorFragment(tv_show)
    }
}