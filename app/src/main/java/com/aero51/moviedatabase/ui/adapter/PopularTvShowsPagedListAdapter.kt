...
class PopularTvShowsPagedListAdapter(private val itemClickListener: MediaClickListener) : PagedListAdapter<PopularTvShow, RecyclerView.ViewHolder>(DIFF_CALLBACK) {
    ...
    class PopularTvShowHolder(itemView: View, itemClickListener: MediaClickListener) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
