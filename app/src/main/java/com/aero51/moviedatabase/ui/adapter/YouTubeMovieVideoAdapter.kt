...
import com.aero51.moviedatabase.repository.model.tmdb.movie.MovieVideosResponse.MovieVideo
...
class YouTubeMovieVideoAdapter(private val context: Context, private val youtubeVideoModelArrayList: List<MovieVideo>?) : RecyclerView.Adapter<YouTubeViewHolder>() {
    ...
    companion object {
        private val TAG = YouTubeMovieVideoAdapter::class.java.simpleName
    }
}