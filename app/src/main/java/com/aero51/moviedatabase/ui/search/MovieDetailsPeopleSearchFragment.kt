...
class MovieDetailsPeopleSearchFragment : Fragment(), MovieCastAdapter.ItemClickListener,
    ...
    private fun registerSharedViewModelObserver() {
        sharedViewModel!!.liveDataPersonSearchMovie.observe(viewLifecycleOwner, Observer { movie ->
