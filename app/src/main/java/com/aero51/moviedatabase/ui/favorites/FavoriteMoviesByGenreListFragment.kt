...
class FavoriteMoviesByGenreListFragment : Fragment(),
    MediaClickListener {
...
*/
    ...
    private fun registerSharedViewModelObserver() {
        ...
        sharedViewModel.liveDataFavoriteMovieGenreId.observe(viewLifecycleOwner, Observer { genreId ->
    ...
    private fun registerMoviesByGenrePagedListObserver(genreId: Int) {
        moviesViewModel.getMoviesByGenre(genreId)
    ...
    private fun registerMoviesByGenrePage() {
        moviesViewModel.moviesByGenrePage.observe(
            viewLifecycleOwner,
    ...
    override fun onMediaItemClick(movie: Any?, position: Int) {
        sharedViewModel.changeToFavouriteMovieDetailsFragmentFromMoviesByGenreListFragment(movie)
    }
}
