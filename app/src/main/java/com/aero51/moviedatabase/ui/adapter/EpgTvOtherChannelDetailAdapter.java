...
public class EpgTvOtherChannelDetailAdapter extends RecyclerView.Adapter<EpgTvOtherChannelDetailAdapter.ViewHolder> {
    private List<EpgProgram> epgPrograms;
    private ProgramItemClickListener mClickListener;

    public EpgTvOtherChannelDetailAdapter(List<EpgProgram> epgPrograms,ProgramItemClickListener mClickListener) {
