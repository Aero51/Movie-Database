...
class FavoriteTvShowsByGenreListFragment : Fragment(),
    MediaClickListener {
...
*/
    ...
    private fun registerSharedViewModelObserver() {
        ...
        sharedViewModel.liveDataFavoriteTvShowGenreId.observe(viewLifecycleOwner, Observer { genreId ->
    ...
    override fun onMediaItemClick(movie: Any?, position: Int) {
        sharedViewModel.changeToFavouriteTvShowDetailsFragmentFromTvShowsByGenreListFragment(movie)
    }
