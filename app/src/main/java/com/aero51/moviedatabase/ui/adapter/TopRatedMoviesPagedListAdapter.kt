...
class TopRatedMoviesPagedListAdapter(private val itemClickListener: MovieClickListener) : PagedListAdapter<TopRatedMovie, RecyclerView.ViewHolder>(DIFF_CALLBACK) {
    ...
    class TopRatedMovieHolder(itemView: View, itemClickListener: MovieClickListener) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
