...
class TopRatedMoviesPagedListAdapter(private val itemClickListener: ObjectClickListener) : PagedListAdapter<TopRatedMovie, RecyclerView.ViewHolder>(DIFF_CALLBACK) {
    ...
    class TopRatedMovieHolder(itemView: View, itemClickListener: ObjectClickListener) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
