...
class TvShowDetailsPeopleSearchFragment : Fragment(), MovieCastAdapter.ItemClickListener,
    ...
    private fun registerSharedViewModelObserver() {
        sharedViewModel!!.liveDataPersonSearchTvShow.observe(viewLifecycleOwner, Observer { tvShow ->
