...
class UpcomingMoviesPagedListAdapter(private val itemClickListener: MediaClickListener) : PagedListAdapter<UpcomingMovie, RecyclerView.ViewHolder>(DIFF_CALLBACK) {
    ...
    class UpcomingMovieHolder(itemView: View, itemClickListener: MediaClickListener) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
