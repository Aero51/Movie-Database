...
class TvShowsByGenreListFragmentSecond : Fragment(),
    MediaClickListener {
...
*/
    ...
    private fun registerSharedViewModelObserver() {
        ...
        sharedViewModel.liveDataTvShowGenreId.observe(viewLifecycleOwner, Observer { genreId ->
    ...
    override fun onMediaItemClick(tvShow: Any?, position: Int) {
        sharedViewModel.changeToTvShowDetailsFragmentFromTvShowByGenreListFragment(tvShow)
    }
